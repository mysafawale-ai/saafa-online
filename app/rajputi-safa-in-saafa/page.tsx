...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saafa.online/rajputi-safa-in-saafa",
    type: "website",
  },
}
...
export default function RajputiSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit"],
