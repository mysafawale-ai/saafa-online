...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saafa.online/wedding-pagdi-for-destination-wedding-in-saafa",
    type: "website",
  },
}
...
export default function WeddingPagdiForDestinationWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations"],
