...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saafa.online/safa-for-barati-in-saafa",
    type: "website",
  },
}
...
export default function SafaForBaratiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders"],
