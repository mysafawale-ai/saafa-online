...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saafa.online/jodhpuri-safa-for-wedding-in-saafa",
    type: "website",
  },
}
...
export default function JodhpuriSafaForWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue", "Emergency last-minute service available in India"],
