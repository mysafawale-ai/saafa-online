...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saafa.online/dulhe-ki-pagdi-in-saafa",
    type: "website",
  },
}
...
export default function DulheKiPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations"],
