...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saafa.online/safa-garments-in-saafa",
    type: "website",
  },
}
...
export default function SafaGarmentsInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert safa specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations"],
