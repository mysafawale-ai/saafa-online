...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saafa.online/dulha-safa-in-saafa",
    type: "website",
  },
}
...
export default function DulhaSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in India"],
