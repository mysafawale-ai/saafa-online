...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saafa.online/mens-wedding-turban-in-saafa",
    type: "website",
  },
}
...
export default function MensWeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations"],
