...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saafa.online/vadodara-groom-pagdi-in-saafa",
    type: "website",
  },
}
...
export default function VadodaraGroomPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations"],
