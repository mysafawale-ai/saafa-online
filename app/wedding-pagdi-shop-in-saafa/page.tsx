...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saafa.online/wedding-pagdi-shop-in-saafa",
    type: "website",
  },
}
...
export default function WeddingPagdiShopInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Expert pagdi specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics"],
