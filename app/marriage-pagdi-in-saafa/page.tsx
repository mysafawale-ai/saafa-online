...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saafa.online/marriage-pagdi-in-saafa",
    type: "website",
  },
}
...
export default function MarriagePagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp"],
