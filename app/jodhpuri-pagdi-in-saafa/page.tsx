...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saafa.online/jodhpuri-pagdi-in-saafa",
    type: "website",
  },
}
...
export default function JodhpuriPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Expert pagdi specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "Emergency last-minute service available in India", "On-site professional service at your India venue"],
